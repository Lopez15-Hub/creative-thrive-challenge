...
class ProductsRepository {
  ...
  Future<List<ProductModel>> getProductsFavorites() async=> await databaseService.retrieveProductsFavorites();
  ...
  Future<void> updateProductIsFavorite(String productId, bool isFavorite) async => await databaseService.updateProductIsFavorite(productId, isFavorite);
}
